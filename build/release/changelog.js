...
function ticketUrl( ticketId ) {
	return `https://github.com/bssyco/jdoc/issues/${ ticketId }`;
}
...
async function getCommits() {
	const format =
		"__COMMIT__%n%s (__TICKETREF__[%h](https://github.com/bssyco/jdoc/commit/%H))%n%b";
...
async function getGitHubContributor( sha ) {
	const response = await fetch(
		`https://github.com/bssyco/jdoc/jdoc/commits/${ sha }`,
		{
			headers: {
