...
import jdocConfig from "eslint-config-jquery";
...
export default [
	...
	// Source
	{
		...
		languageOptions: {
			...
			// jDoc with tools like jsdom which provide a custom window
			// implementation.
			globals: {
				window: false
			}
		...
		rules: {
			...
			// 		// folder of the jDoc repository. This pattern intends to catch both.
	...
	// Tests
	{
		...
		ignores: [
			...
			"test/data/core/jdoc-iterability-transpiled.js"
		],
		languageOptions: {
			ecmaVersion: 5,
			sourceType: "script",
...

	{
		files: [
			...
			"test/data/core/jdoc-iterability-transpiled-es6.js"
		],
		languageOptions: {
			ecmaVersion: 2015,
			sourceType: "script",
...

	{
		files: [
			"dist/jdoc.js",
			"dist/jdoc.slim.js",
			"dist/jdoc.factory.js",
			"dist/jdoc.factory.slim.js",
			"dist-module/jdoc.module.js",
			"dist-module/jdoc.slim.module.js",
			"dist-module/jdoc.factory.module.js",
			"dist-module/jdoc.factory.slim.module.js",
			"dist/wrappers/*.js",
